...
class Marvellous
{
	...
	synchronized public void DisplayEven()//use synchronized keyword
	{
		for(int i=0;i<this.Arr.length;i++)
		{
			if(this.Arr[i]%2==0)
...
{
	public Marvellous mref;//reference of marvellous class 
	public Demo(Marvellous obj)//Prameterise constructor
	{
		this.mref=obj;
	}
	public void run()
